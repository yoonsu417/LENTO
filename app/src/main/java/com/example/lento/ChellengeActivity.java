...
public class ChellengeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chellsetbtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                /*String query = "INSERT INTO CHALLENGE (ENROLL_USER, CATEGORY, TITLE, STARTDATE, DEADLINE) " +
                        "VALUES ('" + set_user + "', '" + category + "', '" + title + "', '" + startDate + "', '" + endDate + "')";
                db.execSQL(query);
                db.close();
                ...
                if (db != null) {
                    ...
                    if (result == -1) {
                        ...
                        Toast.makeText(ChellengeActivity.this, "Failed to insert data", Toast.LENGTH_SHORT).show();
                    } else {
                        Log.d("Initialchell2Activity", "Data inserted successfully into CHALLENGE table");
                        Toast.makeText(ChellengeActivity.this, "Data inserted successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ChellengeActivity.this, MypageActivity.class);
                        startActivity(intent);
                    }
                    db.close();
                } else {
                    Log.e("Initialchell2Activity", "Error accessing database");
                    Toast.makeText(ChellengeActivity.this, "Failed to access database", Toast.LENGTH_SHORT).show();
                }
